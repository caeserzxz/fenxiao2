...
class FindGoods extends MobileBase
{
    ...
    public function goods_list()
    {
        ...
        $this->assign('U','Mobile/FindGoods/goods_list');
        $this->assign('title', '发现好货');
        $url = '/index.php?m=Mobile&c=FindGoods&is_ajax=1&a=goods_list&goods_type=find&p=';
        $this->assign('url', $url);
