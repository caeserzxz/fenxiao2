...
//        $accessKeyId = "LTAIPyUwTdvNSSMF"; // AccessKeyId
        $accessKeyId = "LTAIA3gsbTCVN3XV"; // AccessKeyId  尼希瑞

//        $accessKeySecret = "yourAccessKeySecret"; // AccessKeySecret
//        $accessKeySecret = "4rLc870Dr8FlKI2HrJxGVLxosyOQ6m"; // AccessKeySecret
        $accessKeySecret = "VEpKSZKW3uLNeTGdf35tCVzvfDgmOO"; // AccessKeySecret 尼希瑞
        // 暂时不支持多Region
        $region = "cn-hangzhou";
...
//        dump($product);die;
        ...
        $request->setSignName("尼希瑞");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_165418262");
