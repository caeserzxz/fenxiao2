...
class Common_util_pub
{
	...
	public function getSign($Obj)
	{
		...
		//签名步骤二：在string后加入KEY
		$String = $String."&key=".Cache::get("wechart_key","");
...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function createXml()
	{
	   	$this->parameters["appid"] =  Cache::get("wechart_app_id","");//公众账号ID
	   	$this->parameters["mch_id"] =  Cache::get("wechart_mch_id","");//商户号
 ...
 * @author east
 */
 class WxPayToUser extends Wxpay_client_pub
 {
    var $code;//code码，用以获取openid
    var $openid;//用户的openid
...
//            $this->parameters["mchid"] = WxPayConf_pub::MCHID;//商户号
            $this->parameters["mch_appid"] = Cache::get("wechart_app_id","");//公众账号ID
            $this->parameters["mchid"] =  Cache::get("wechart_mch_id","");//商户号
    ...
    function createOauthUrlForOpenid()
    {
        $urlObj["appid"] = Cache::get("wechart_app_id","");
        $urlObj["secret"] = Cache::get("wechart_app_secret","");
        $urlObj["code"] = $this->code;
        $urlObj["grant_type"] = "authorization_code";
        $bizString = $this->formatBizQueryParaMap($urlObj, false);
        return "https://api.weixin.qq.com/sns/oauth2/access_token?".$bizString;
 ...
 class WxPayToCar extends Wxpay_client_pub{
...
//            $this->parameters["mchid"] = WxPayConf_pub::MCHID;//商户号
 ...
 class WxPem extends Wxpay_client_pub{
     function __construct()
     {
         //设置接口链接
