...
//		dump($this->gateway_url);
//		dump($this->appid);
//		dump($this->private_key);
//		dump($this->alipay_public_key);
//		dump($this->charset);
//		dump($this->signtype);
//		die;
...
//		Log::error("biz_content-".json_encode($biz_content));
...
//		Log::error("response-".json_encode($this->aopclientRequestExecute ($request,true)));
